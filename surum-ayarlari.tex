...
% --- Sürüm Bilgisi ---
\newcommand{\kitapsurum}{0.3.5}

% --- Çalışma Modu ---
% Günlük çalışma: sadece aktif bölümü derlemek için aşağıdaki satırı aç.
% Tam derleme veya sürüm hazırlığı için yorum satırı yap.
% Günlük çalışma: sadece aktif bölümü derle (uncomment et)
%\includeonly{bolum04-programlama/bolum04-programlama}

% Yayın sürümü: sadece yayındaki bölümleri derle (uncomment et)
\includeonly{bolum01-giris/bolum01,bolum02-basarim/bolum02,bolum03-buyruk-kumesi/bolum03,bolum04-programlama/bolum04-programlama,ekA-sayi-sistemleri/ekA,ekC-risc-v-referans/ekC,ekD-pratik-rehber/ekD}
