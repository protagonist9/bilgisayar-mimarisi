...
\begin{tikzpicture}[remember picture, overlay]
    ...
    % Görsel yatay formatta; dikeyde sayfayı kaplayacak şekilde ölçekle, yanlarda kırp
    \begin{scope}
        \clip (current page.south west) rectangle (current page.north east);
        \node[inner sep=0pt] at (current page.center) {%
            \includegraphics[height=\paperheight]{gorseller/kapak-arkaplan.png}%
        };
    \end{scope}
    ...
    \node[font=\normalsize, text=pcbaltin, opacity=0.7]
        at ([yshift=1.8cm]current page.south) {Sürüm 0.1.0\ \ $\cdot$\ \ \the\year};
